...
class TestDataBase:
    ...
    def test_available_buns_datebase(self, index_bun, bun_name, bun_price):
    ...
    def test_available_ingredients_datebase(self, index_i, type_ingredient, name_ingredient, price_ingredient):
        database: Database = Database()
